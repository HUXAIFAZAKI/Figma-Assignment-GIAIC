  ...
  return (
    <header className='' style={{backgroundColor:'#A29875'}}>
      <ul className='nav flex flex-wrap justify-between items-center p-5 '>
        ...
        className="w-full rounded-l-xl h-[36px] py-5 px-6 select-none cursor-text focus:outline-none  focus:border-none"/>
          <Link href='/'>
        ...
        <div className='side-icons flex items-center justify-evenly w-[12rem] mr-[2.5%] cursor-pointer'>
